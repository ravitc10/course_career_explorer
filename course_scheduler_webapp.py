...
# ------------------- PAGE 2 -------------------
    ...
    st.image("Rios_et_al_chart.png", caption="Figure from Rios et al (2020) " \
    "showing the percentage of cross-disciplinary employers that find particular skills important.")
...
# ------------------- PAGE 3 -------------------
    ...
    # Continue button to go to Page 4
    st.markdown("---")
    if st.button("Continue"):
        go_to_page("page_4")
...
# ------------------- PAGE 4 -------------------
    ...
    st.markdown(
        ...
        use skill(s) mentioned in this chart or choose to feature a different set of skills that is p
        ertinent to your particular career pathway. In the example below, the student chose some skills
    ...
    # Continue button to go to page 5
    st.markdown("---")
    if st.button("Continue"):
        go_to_page("page_5")
...
# ------------------- PAGE 5 -------------------
    ...
    st.markdown(
        ...
        these comments ways in which you disagree with the representations created by 
        the Visual Open Curriculum. When you are finished adding to the Padlet, please return to this
...
# ------------------- PAGE 8 -------------------
    ...
    st.markdown(
        """
        Great job finding five jobs of interest to you!
